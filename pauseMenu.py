...
def p():
    ...
    def pause():
        ...
        move_1_r=move_1.get_rect(center=(WIDTH/2+300,HEIGHT/2-100))
        move_2_r=move_2.get_rect(center=(WIDTH/2+300,HEIGHT/2-0))
        move_3_r=move_3.get_rect(center=(WIDTH/2+300,HEIGHT/2+100))
        move_4_r=move_4.get_rect(center=(WIDTH/2+300,HEIGHT/2+200))
        ...
        box = pygame.Rect(WIDTH/2-225, HEIGHT/2-200, 350, 460)
        pygame.draw.rect(screen, (255, 255, 255), box)
        pygame.draw.rect(screen, (0, 0, 0), box, 2)

        descBox = pygame.Rect(WIDTH/2-350, HEIGHT/2+230, 350, 60)
        ...
        lvl_box = pygame.Rect(WIDTH/2-225, HEIGHT/2-460, 350, 30)
        pygame.draw.rect(screen, (255, 255, 255), lvl_box)
        pygame.draw.rect(screen, (0, 0, 0), lvl_box, 2)

        stat_box = pygame.Rect(WIDTH/2-225, HEIGHT/2+50, 350, 50)
